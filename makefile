LIBRARY :=  ALU/ALU.v  ALU/adder.v  ALU/extend.v  ALU/utype_alu.v ALU/sgn_extend.v ALU/rd2ext_4to0.v \
	multicycle_dp/hazard.v multicycle_dp/mlt_ctrl_datapath.v multicycle_dp/mlt_dp_regs.v multicycle_dp/mlt_top.v \
	decoder/mlt_decoder.v decoder/inst_decoder.v decoder/signal_controller.v \
	decoder/load_wait.v \
